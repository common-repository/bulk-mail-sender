...
<div class="col-xl-10 col-lg-11 col-md-11 col-bg-img">
<?php

        if(is_bulk_mail_pro_activated()){
            require_once (BMSI_PRO_DIR_PATH . 'templates/BMSIProDashboard.php');
        }else{ ?>
        <div class="dashboard-bg-image d-flex justify-content-center align-items-center">
